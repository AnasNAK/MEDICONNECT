<x-guest-layout>
    <div class="max-w-md mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        <h1 class="text-4xl text-center text-white font-extrabold mb-8">Create Speciality</h1>
        ...
        <form action="{{ route('specialities.store') }}" method="POST">
            ...
            <button type="submit"
                class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-md transition-colors duration-300 transform hover:scale-105">Submit</button>
        </form>
    </div>
